...
// Middleware para asegurar UTF-8 en respuestas (ANTES de cualquier route)
app.use((req, res, next) => {
  // Override del método json para forzar charset UTF-8
...
const notificacionesController = require('./src/controllers/configuracion/notificaciones.controller');
