    ...
    <div className="card debts-card">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
        <h1 className="debts-title" style={{ margin: 0, display: 'flex', alignItems: 'center', gap: 10 }}>
          {tab === 'deudas' ? React.createElement(FaMoneyBillWave as any) : React.createElement(FaBullseye as any)}
          Deudas y Metas
        </h1>
      ...
      <div style={{ 
        ...
        <div style={{ flex: '0 0 auto', display: 'flex', alignItems: 'center', gap: 8 }}>
          {React.createElement(FaFilter as any, { style: { color: 'var(--color-muted)', fontSize: 14 } })}
          <select 
            value={filtroEstado}
        ...
        {/* Ordenamiento */}
        <div style={{ flex: '0 0 auto', display: 'flex', alignItems: 'center', gap: 8 }}>
          {React.createElement(FaSortAmountDown as any, { style: { color: 'var(--color-muted)', fontSize: 14 } })}
          <select 
            value={ordenamiento}
