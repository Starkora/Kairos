...
import { FaBolt, FaFileDownload, FaFileUpload, FaWallet, FaExclamationTriangle, FaLightbulb, FaMoneyBillWave, FaUniversity, FaAppleAlt, FaCar, FaCreditCard, FaBolt as FaLightning, FaGift, FaShoppingCart, FaHospital, FaExchangeAlt, FaCheckCircle, FaTimesCircle } from 'react-icons/fa';
